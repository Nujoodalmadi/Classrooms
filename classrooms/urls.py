...
urlpatterns = [
    ...
    #path('/add/student/<int:classroom_id>',views.student_create ,name='student-create'),
    path('classrooms/add/<int:classroom_id>',views.student_create ,name='student-create'),
